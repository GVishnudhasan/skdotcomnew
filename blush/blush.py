...
blush_app = Blueprint('blush', __name__, template_folder='blushtemplate', static_folder='static', static_url_path='/static/blush')

@blush_app.route('/', methods=['GET'])
def index():
    
    colors = config.get('service', {}).get('blush', {}).get('colors', [])
